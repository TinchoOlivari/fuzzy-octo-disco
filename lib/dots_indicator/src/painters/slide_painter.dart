...
class SlidePainter extends BasicIndicatorPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final activeDotBorderPainter = Paint()..color = effect.activeDotBorderColor;
    final rBorder = RRect.fromLTRBR(
      (xPos) - effect.activeDotBorderWidth,
      (yPos - effect.dotHeight / 2) - effect.activeDotBorderWidth,
      (xPos + effect.dotWidth) + effect.activeDotBorderWidth,
      (yPos + effect.dotHeight / 2) + effect.activeDotBorderWidth,
      dotRadius,
    );

    canvas.drawRRect(rBorder, activeDotBorderPainter);
